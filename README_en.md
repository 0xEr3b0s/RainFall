# Rainfall
> Security challenges focused on binaries: buffer overflows, printf insertions, shellcode injections and binary analysis. The project resources (ISO and subject) are available through the school's intranet.
...
![header_rainfall](docs/header_rainfall.png)
